...
<div class="header" style="padding: 0;">
    <h3 style="text-align:center;font-weight: lighter; color: white; width: 550px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">
        学生管理系统 —— SMS
    </h3>
</div>
...
<!-- 页面底部版权声明 -->
<div class="footer">
    Copyright @ 2021 钟荣伟. All rights reserved
</div>
</body>
</html>